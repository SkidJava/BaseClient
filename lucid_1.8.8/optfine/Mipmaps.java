...
public class Mipmaps
{
    ...
    public Mipmaps(String p_i58_1_, int p_i58_2_, int p_i58_3_, int[] p_i58_4_, boolean p_i58_5_)
    {
        this.iconName = p_i58_1_;
        this.width = p_i58_2_;
        this.height = p_i58_3_;
        this.data = p_i58_4_;
        this.direct = p_i58_5_;
        this.mipmapDimensions = makeMipmapDimensions(p_i58_2_, p_i58_3_, p_i58_1_);
        this.mipmapDatas = generateMipMapData(p_i58_4_, p_i58_2_, p_i58_3_, this.mipmapDimensions);
