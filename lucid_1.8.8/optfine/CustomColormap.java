...
public class CustomColormap implements CustomColors.IColorizer
{
    ...
    public CustomColormap(Properties p_i32_1_, String p_i32_2_, int p_i32_3_, int p_i32_4_)
    {
        ...
        this.format = this.parseFormat(p_i32_1_.getProperty("format"));
        this.matchBlocks = connectedparser.parseMatchBlocks(p_i32_1_.getProperty("blocks"));
        this.source = parseTexture(p_i32_1_.getProperty("source"), p_i32_2_, this.basePath);
        this.color = ConnectedParser.parseColor(p_i32_1_.getProperty("color"), -1);
        this.yVariance = connectedparser.parseInt(p_i32_1_.getProperty("yVariance"), 0);
        this.yOffset = connectedparser.parseInt(p_i32_1_.getProperty("yOffset"), 0);
        this.width = p_i32_3_;
        this.height = p_i32_4_;
    }
