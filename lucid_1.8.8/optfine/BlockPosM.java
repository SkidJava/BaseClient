...
public class BlockPosM extends BlockPos
{
    ...
    public BlockPosM(int p_i13_1_, int p_i13_2_, int p_i13_3_)
    {
        this(p_i13_1_, p_i13_2_, p_i13_3_, 0);
    }
    ...
    public BlockPosM(int p_i15_1_, int p_i15_2_, int p_i15_3_, int p_i15_4_)
    {
        super(0, 0, 0);
        this.mx = p_i15_1_;
        this.my = p_i15_2_;
