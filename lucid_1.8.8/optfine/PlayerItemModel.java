...
public class PlayerItemModel
{
    ...
    public PlayerItemModel(Dimension p_i66_1_, boolean p_i66_2_, PlayerItemRenderer[] p_i66_3_)
    {
        this.textureSize = p_i66_1_;
        this.usePlayerTexture = p_i66_2_;
        this.modelRenderers = p_i66_3_;
    }
