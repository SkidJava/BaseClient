...
public class InventoryCleaner extends Command
{
    ...
    public void runCommand(final String[] args) {
        try {
            ...
            if (args[1].equalsIgnoreCase("add") || args[1].equalsIgnoreCase("a")) {
                ...
                if (client.modules.misc.InventoryCleaner.cleanIDs.contains(id)) {
                    ChatUtils.sendClientMessage(String.valueOf(id) + " is already on the InventoryCleaner list.");
                }
                else {
                    client.modules.misc.InventoryCleaner.cleanIDs.add(id);
                ...
                final int id = Integer.parseInt(args[2]);
                if (client.modules.misc.InventoryCleaner.cleanIDs.contains(id)) {
                    if (client.modules.misc.InventoryCleaner.cleanIDs.remove((Object)id)) {
                ...
                for (final int i : client.modules.misc.InventoryCleaner.cleanIDs) {
                ...
                client.modules.misc.InventoryCleaner.cleanIDs.clear();
    ...
    public static void load() {
        ...
        for (final String intS : content) {
            ...
            client.modules.misc.InventoryCleaner.cleanIDs.add(i);
        }
    }
}