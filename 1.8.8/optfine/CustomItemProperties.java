...
public class CustomItemProperties
{
    ...
    public CustomItemProperties(Properties p_i33_1_, String p_i33_2_)
    {
        ...
        this.texture = parseTexture(p_i33_1_.getProperty("texture"), p_i33_1_.getProperty("tile"), p_i33_1_.getProperty("source"), p_i33_2_, this.basePath, this.type, this.mapTextures);
        ...
        this.enchantmentIds = this.parseRangeListInt(p_i33_1_.getProperty("enchantmentIDs"));
