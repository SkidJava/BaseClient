...
public class RandomMobsProperties
{
    ...
    public RandomMobsProperties(String p_i70_1_, ResourceLocation[] p_i70_2_)
    {
        ConnectedParser connectedparser = new ConnectedParser("RandomMobs");
        this.name = connectedparser.parseName(p_i70_1_);
        this.basePath = connectedparser.parseBasePath(p_i70_1_);
        this.resourceLocations = p_i70_2_;
    }

    public RandomMobsProperties(Properties p_i71_1_, String p_i71_2_, ResourceLocation p_i71_3_)
    {
        ConnectedParser connectedparser = new ConnectedParser("RandomMobs");
        this.name = connectedparser.parseName(p_i71_2_);
        this.basePath = connectedparser.parseBasePath(p_i71_2_);
        this.rules = this.parseRules(p_i71_1_, p_i71_3_, connectedparser);
    }
