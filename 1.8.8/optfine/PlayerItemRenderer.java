...
public class PlayerItemRenderer
{
    ...
    public PlayerItemRenderer(int p_i67_1_, float p_i67_2_, ModelRenderer p_i67_3_)
    {
        this.attachTo = p_i67_1_;
        this.scaleFactor = p_i67_2_;
        this.modelRenderer = p_i67_3_;
    }
