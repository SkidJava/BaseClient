...
public class CustomSkyLayer
{
    ...
    public CustomSkyLayer(Properties p_i34_1_, String p_i34_2_)
    {
        ...
        this.source = p_i34_1_.getProperty("source", p_i34_2_);
        this.startFadeIn = this.parseTime(p_i34_1_.getProperty("startFadeIn"));
        this.endFadeIn = this.parseTime(p_i34_1_.getProperty("endFadeIn"));
        this.startFadeOut = this.parseTime(p_i34_1_.getProperty("startFadeOut"));
        this.endFadeOut = this.parseTime(p_i34_1_.getProperty("endFadeOut"));
        this.blend = Blender.parseBlend(p_i34_1_.getProperty("blend"));
        this.rotate = this.parseBoolean(p_i34_1_.getProperty("rotate"), true);
        this.speed = this.parseFloat(p_i34_1_.getProperty("speed"), 1.0F);
        this.axis = this.parseAxis(p_i34_1_.getProperty("axis"), DEFAULT_AXIS);
        this.days = connectedparser.parseRangeListInt(p_i34_1_.getProperty("days"));
        this.daysLoop = connectedparser.parseInt(p_i34_1_.getProperty("daysLoop"), 8);
    }
