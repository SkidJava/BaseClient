 ...
 */
package client.management.module;
...
public class Module {
    ...
    public List<client.management.option.Option> getOptions() {
        ArrayList<client.management.option.Option> list = new ArrayList<client.management.option.Option>();
        for (client.management.option.Option option : OptionManager.optionList) {
