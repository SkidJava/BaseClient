...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    private ModelRotation(String p_i19_3_, int p_i19_4_, int p_i19_5_, int p_i19_6_)
    {
        this.combinedXY = combineXY(p_i19_5_, p_i19_6_);
        this.matrix4d = new Matrix4f();
        Matrix4f matrix4f = new Matrix4f();
        matrix4f.setIdentity();
        Matrix4f.rotate((float)(-p_i19_5_) * 0.017453292F, new Vector3f(1.0F, 0.0F, 0.0F), matrix4f, matrix4f);
        this.quartersX = MathHelper.abs_int(p_i19_5_ / 90);
        Matrix4f matrix4f1 = new Matrix4f();
        matrix4f1.setIdentity();
        Matrix4f.rotate((float)(-p_i19_6_) * 0.017453292F, new Vector3f(0.0F, 1.0F, 0.0F), matrix4f1, matrix4f1);
        this.quartersY = MathHelper.abs_int(p_i19_6_ / 90);
