			...
			if (worldIn.rand.nextInt(4) == 0) {
				...
				if (enumfacing1 == EnumFacing.UP && pos.getY() < 255 && worldIn.isAirBlock(blockpos1)) {
					if (!flag) {
						...
						for (Object enumfacing0 : EnumFacing.Plane.HORIZONTAL) {
							EnumFacing enumfacing3 = (EnumFacing) enumfacing0;
							if (rand.nextBoolean() || !this
									.canPlaceOn(worldIn.getBlockState(blockpos1.offset(enumfacing3)).getBlock())) {
								iblockstate2 = iblockstate2.withProperty(getPropertyFor(enumfacing3),
					...
					if (pos.getY() > 1) {
						...
						if (block.blockMaterial == Material.air) {
							...
							for (Object enumfacing0 : EnumFacing.Plane.HORIZONTAL) {
								EnumFacing enumfacing = (EnumFacing) enumfacing0;
								if (rand.nextBoolean()) {
									iblockstate1 = iblockstate1.withProperty(getPropertyFor(enumfacing),
											Boolean.valueOf(false));
								}
							}
							...
							for (Object enumfacing0 : EnumFacing.Plane.HORIZONTAL) {
								EnumFacing enumfacing5 = (EnumFacing) enumfacing0;
