...
public enum EnumFacing implements IStringSerializable
{
    ...
    private EnumFacing(String p_i31_3_, int p_i31_4_, int p_i31_5_, int p_i31_6_, int p_i31_7_, String p_i31_8_, EnumFacing.AxisDirection p_i31_9_, EnumFacing.Axis p_i31_10_, Vec3i p_i31_11_)
    {
        this.index = p_i31_5_;
    ...
    public static enum Axis implements Predicate, IStringSerializable {
        ...
        private Axis(String p_i28_3_, int p_i28_4_, String p_i28_5_, EnumFacing.Plane p_i28_6_)
        {
            this.name = p_i28_5_;
            this.plane = p_i28_6_;
        }
